    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num', models.IntegerField(max_length=11, verbose_name='手机')),
                ('mail', models.CharField(max_length=62, verbose_name='邮箱')),
                ...
                ('depart_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='app01.department')),
            ],
        ),
    ]
